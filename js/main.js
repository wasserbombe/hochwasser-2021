(function(){
        ...
        Highcharts.chart('tweets-per-hour-per-search', {
            ...
            xAxis: {
                ...
                plotBands: [{
                    ...
                    color: 'rgba(0, 0, 0, 0.2)',
                    from: new Date("2021-07-17T12:00:00").getTime(),
                    to: new Date("2021-07-19T08:00:00").getTime(),
                    zIndex: 6,
                    label: {
                        rotation: 90,
                        text: ""
                ...
                plotLines: [{
                    ...
                    color: 'darkgray',
                    width: 1,
                    value: new Date("2021-07-15T02:00:00").getTime(),
                    zIndex: 6,
                    dashStyle: "LongDash",
                    label: {
                        text: "Hochwasser in RLP + NRW"
                    }
                }]
            },
            yAxis: [{
    ...
    API.getView('all-topics').then((data) => {
        data.forEach((elem) => {
            $("#topics-selection").append($("<option>").text(elem.topic + ' ('+ elem.tweets+')'));
        });
        $("#topics-selection").select2(); 
    });
})(); 